...
KEYSTROKE_TRIGGER_TMS = ord('J')
KEYSTROKE_TOGGLE_TMS_GENERATOR = ord('K')
KEYSTROKE_ALLOW_OFF_TARGET_TMS = ord('L')
ALLOW_OFF_TARGET_TMS = False
PULSE_GENERATOR_ON = False
PERMISSION_TO_STIMULATE = True
MAXIMUM_DISTANCE_FROM_SURFACE = 20 # Originally it was 20